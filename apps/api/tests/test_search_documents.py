...
def test_deal_search_document_keeps_favorite_count_signal() -> None:
    deal = Deal(
        id="deal-1",
        product_id="product-1",
        title="Galaxy S26 launch deal",
    ...
    document = build_deal_document(deal, favorite_count=9)

    assert document["favoriteCount"] == 9
...
def test_auction_search_document_keeps_view_momentum_signal() -> None:
    auction = Auction(
        id="auction-1",
        product_id="product-1",
        title="Galaxy S26 sealed auction",
    ...
    document = build_auction_document(auction, view_momentum=11)

    assert document["viewMomentum"] == 11
